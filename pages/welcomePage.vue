                ...
                <div class="progress__inner">
                    <div class="user__greetings">
                        ...
                        <div class="button__add-goal">
                            <div  v-if="authStore.isPremium" class="animation__wrapper">
                                <div class="premium__text">{{ $t('isPremium.value') }}</div>
                                <div class="animation"></div>
                            </div>
                            <button v-else @click="toPremium" class="goal__btn">
                                <img :src="PremiumIcon" alt="" class="goal__btn-icon"/>
                            </button>
