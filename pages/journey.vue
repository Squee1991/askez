							...
							<div class="goal-switcher-scroll" ref="scrollContainer">
								...
								>
									<div class="goal__header">
										...
										<!--                                        <div class="goal__image-block">-->
										<!--                                            <img :src="getGoalImage(goal.image)" alt="goal" class="goal__image" />-->
										<!--                                        </div>-->
										<img @click.stop="openModal(goal.id)" class="clear-button"
										     src="../assets/images/broom.svg" alt="">
									</div>
									<div v-if="goal.id === selectedGoalId" class="goal-progress-container">
										<div class="goal-progress-text">{{ goal.entries?.length || 0 }} / {{ goal.target
											}}
										</div>
										<div class="progress__icon">
											<div class="progress-bar-bg">
												<div class="progress-bar-fill"
												     :style="{ width: Math.min((goal.entries?.length || 0) / goal.target * 100, 100) + '%' }"></div>
											</div>
											<div class="goal__image-block">
												<img :src="getGoalImage(goal.image)" alt="goal" class="goal__image"/>
											</div>
...
<script setup>
	...
	import books from '../assets/images/read_books.svg'
	import sleep from '../assets/images/wake_up.svg'
	import water from '../assets/images/drink_water.svg'
	import meditate from '../assets/images/meditation.svg'
	import wake_7am from '../assets/images/wake_up.svg'
	import evening_run from '../assets/images/run.svg'
	import no_sugar from '../assets/images/no_sugar.svg'
	import alcohol from '../assets/images/no_alcohol.svg'
	import media from '../assets/images/social_media.svg'
...
<style scoped>
	...
	.goal-slide {
		...
		border: none;
		border-radius: 20px;
		background: linear-gradient(135deg, #a477f1, #d2b7ff);
		color: white;
		font-weight: bold;
		cursor: pointer;
		font-size: 23px;
