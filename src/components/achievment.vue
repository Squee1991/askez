<template>
	<div class="achieve__inner">
		...
		<!-- Завершённые -->
		<div v-if="completedAchievements.length" class="achieve__list-wrapper">
			<div class="achieve__list-title">{{ $t('achieveTitle.achiveDone') }}</div>
		...
		<!-- В процессе -->
		<div v-if="inProgressAchievements.length" class="achieve__list-wrapper">
			<div class="achieve__list-title">{{ $t('achieveTitle.achiveInProgress') }}</div>
			<div class="achieve__list">
				<div
...
import Panda1 from '../../assets/images/1 goal done.png'
import Panda2 from '../../assets/images/10 goal done.png'
import Panda3 from '../../assets/images/20 goal done.png'
import Panda4 from '../../assets/images/50 goal done.png'
import Panda5 from '../../assets/images/70 goal done.png'
import Panda6 from '../../assets/images/100 goal done.png'
import Panda7 from '../../assets/images/120 goal done.png'
...
const completedAchievements = computed(() =>
		achievementData.value.filter(item => item.isActive)
)
